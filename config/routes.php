...
$router->post('api/orderitems/update', 'ApiOrdercontroller@updateOrderItem');
...
$router->get('utilizatori', 'management/UtilizatoriController@index');
...
$router->post('api/shipping/delete',  'ApiShippingController@delete');
...
$router->get('import/products', 'ImportController@products');
